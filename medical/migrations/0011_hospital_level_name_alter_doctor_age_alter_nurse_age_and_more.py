# Generated by Django 4.0.2 on 2022-05-19 08:32
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('medical', '0010_alter_doctor_age_alter_nurse_age_alter_patient_age_and_more'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='hospital',
            name='level_name',
            field=models.IntegerField(blank=True, choices=[(0, '甲等'), (1, '乙等'), (2, '丙等')], default=1),
        ),
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2022, 5, 19, 16, 32, 49, 819266), null=True),
        ),
        migrations.AlterField(
