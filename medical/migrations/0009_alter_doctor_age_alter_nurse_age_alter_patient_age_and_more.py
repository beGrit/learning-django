...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('medical', '0008_rename_name_visitor_ip_address_remove_visitor_age_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2022, 5, 19, 13, 6, 14, 254088), null=True),
        ),
        migrations.AlterField(
