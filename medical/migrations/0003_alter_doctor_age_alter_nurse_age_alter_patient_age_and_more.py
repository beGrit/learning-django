...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('medical', '0002_staticsvirusdata_description_alter_doctor_age_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2022, 5, 15, 0, 21, 26, 85541), null=True),
        ),
        migrations.AlterField(
            model_name='visitor',
            name='telphone',
