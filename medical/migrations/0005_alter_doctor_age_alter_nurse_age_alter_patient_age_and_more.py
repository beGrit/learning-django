...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('medical', '0004_alter_doctor_age_alter_nurse_age_alter_patient_age_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2022, 5, 15, 1, 16, 17, 629026), null=True),
        ),
        migrations.AlterField(
            model_name='visitor',
            name='telphone',
