...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('medical', '0013_alter_doctor_age_alter_nurse_age_alter_patient_age_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2022, 5, 20, 0, 34, 37, 529842), null=True),
        ),
        migrations.AlterField(
